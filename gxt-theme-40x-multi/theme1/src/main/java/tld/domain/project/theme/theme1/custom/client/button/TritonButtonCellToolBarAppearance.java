...
public class TritonButtonCellToolBarAppearance<M> extends TritonButtonCellAppearance<M> {
  ...
  public interface TritonButtonCellResources extends Css3ButtonResources {
    ...
    @Override
    @Source({"tld/domain/project/theme/theme1/client/base/button/Css3ButtonCell.gss",
            "tld/domain/project/theme/theme1/client/base/button/Css3ButtonCellToolBar.gss", "TritonButtonCellToolBar.gss"})
