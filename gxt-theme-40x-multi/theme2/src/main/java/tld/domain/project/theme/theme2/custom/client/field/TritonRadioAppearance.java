...
import tld.domain.project.theme.theme2.client.base.field.Css3RadioAppearance;
...
public class TritonRadioAppearance extends Css3RadioAppearance {
  ...
  public interface TritonRadioResources extends Css3RadioResources {
    ...
    @Override
    @Source({"tld/domain/project/theme/theme2/client/base/field/Css3ValueBaseField.gss",
            "tld/domain/project/theme/theme2/client/base/field/Css3CheckBox.gss",
            "tld/domain/project/theme/theme2/client/base/field/Css3Radio.gss", "TritonRadio.gss"})
