...
import tld.domain.project.theme.theme2.client.base.field.Css3CheckBoxAppearance;
...
public class TritonCheckBoxAppearance extends Css3CheckBoxAppearance {
  ...
  public interface TritonCheckBoxResources extends Css3CheckBoxResources {
    ...
    @Source({"tld/domain/project/theme/theme2/client/base/field/Css3ValueBaseField.gss",
            "tld/domain/project/theme/theme2/client/base/field/Css3CheckBox.gss", "TritonCheckBox.gss"})
